...
public class HqGlobal {
	...
	public static int K_rightwidth = 60;
	public static int K_titleHeight = 25;
	public static int K_timeaxisHeight = 20;
	public static int KlineViewtype = 1;
