...
//		hiddenToolBar(); 
	...
	protected void openChild(int pos, int position) {
		...
		if(position==0) {
			FairyUI.switchToWnd(Global.NJZQ_NZBD_CFPD_MRJP,  CfpdActivity.this);
		}
		else if(position==1) {
			FairyUI.switchToWnd(Global.NJZQ_NZBD_CFPD_TZLT ,  CfpdActivity.this);
		}else if(position==2){
			FairyUI.switchToWnd(Global.NJZQ_NZBD_CFPD_JTPX ,  CfpdActivity.this);
		}
	}
}
